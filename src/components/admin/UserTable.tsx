                        ...
                        <tr>
                            <th className="px-4 py-4 w-12 border-b border-[var(--border-light)]">
                                <input
                                    ...
                                    className="w-4 h-4 rounded border-[var(--border-medium)] text-blue-400 focus:ring-blue-500 cursor-pointer"
                                />
                            </th>
                            {[
                                ...
                                <td className="p-4">
                                    <div className="flex flex-wrap gap-2">
                                        <button
                                            ...
                                            className="px-3 py-1 bg-[var(--bg-secondary)] hover:bg-slate-800 text-[var(--text-secondary)] rounded text-xs transition-colors"
                                        >
                                            View/Edit
                                        </button>
                                        {user.membership !== 'PRO' && (
