                    ...
                    <div className="hidden md:flex items-center gap-4">
                        ...
                        {status === 'loading' ? (
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link
                                    href="/bookmap-lp"
                                    className="p-2 rounded-lg text-[#94A3B8] hover:text-orange-400 hover:bg-orange-400/10 transition-all"
                                    title="Bookmap LP"
                                >
                                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                        ...
                                        <Popover.Content sideOffset={8} align="end" className="z-50">
                                            ...
                                            >
                                                ...
                                                <div className="py-1 border-b border-[#1F2937]">
                                                    ...
                                                    <Link
                                                        href="/bookmap-lp"
                                                        className="flex items-center gap-2 px-3 py-2 text-sm text-[#94A3B8] hover:bg-orange-500/10 hover:text-orange-400 rounded-lg transition-colors"
                                                    >
                                                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                                            <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
                                                        </svg>
                            ...
                            <div className="py-4 space-y-3 border-t border-[#1F2937]">
                                ...
                                {session && (
                                    <div className="px-4 py-2 border-t border-[#1F2937] space-y-2">
                                        ...
                                        <Link
                                            href="/bookmap-lp"
                                            className="flex items-center px-2 py-2 text-[#94A3B8] hover:text-orange-400 transition-colors"
                                            onClick={() => setIsMobileMenuOpen(false)}
                                        >
                                            <svg className="w-5 h-5 inline mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
