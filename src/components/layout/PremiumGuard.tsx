...
export default function PremiumGuard({
    ...
    return (
        <div className="relative w-full min-h-[600px] rounded-3xl overflow-hidden border border-[var(--border-light)] bg-white dark:bg-gray-900">
            ...
            {/* Overlay */}
            <div className="absolute inset-0 bg-white/60 dark:bg-black/60 backdrop-blur-sm z-10 flex flex-col items-center justify-center p-6 text-center">
                <motion.div
                    initial={{ scale: 0.9, opacity: 0 }}
                    animate={{ scale: 1, opacity: 1 }}
                    className="max-w-md bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl border border-[var(--border-light)]"
                >
