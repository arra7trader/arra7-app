// Premium SVG Icons Component
// Enhanced Heroicons with bolder strokes (2.0) for premium appearance
...
// Trading & Analysis Icons - Premium Bold Style
...
export const CrosshairIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3.75H6A2.25 2.25 0 003.75 6v1.5M16.5 3.75H18A2.25 2.25 0 0120.25 6v1.5m0 9V18A2.25 2.25 0 0118 20.25h-1.5m-9 0H6A2.25 2.25 0 013.75 18v-1.5M12 8.25v7.5m3.75-3.75h-7.5" />
    </svg>
);
...
export const XCircleIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const GemIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const BellIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const HeartSolidIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="currentColor" viewBox="0 0 24 24">
...
export const DevicePhoneIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
    </svg>
);

export const CpuChipIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const AcademicCapIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const HeatmapIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" />
    </svg>
);

// Additional Icons for Frontend
export const StarSolidIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="currentColor" viewBox="0 0 20 20">
...
export const ComputerIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25" />
    </svg>
);

export const AndroidIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} viewBox="0 0 24 24" fill="currentColor">
        <path d="M17.6 11.4c-.2-.3-.5-.5-.8-.6l1.3-2.2c.1-.2.1-.4-.1-.5-.2-.1-.4-.1-.5.1l-1.3 2.2c-.8-.4-1.7-.6-2.6-.6s-1.8.2-2.6.6L9.7 8.2c-.1-.2-.3-.3-.5-.1-.2.1-.3.3-.1.5l1.3 2.2c-.4.2-.7.4-.9.7-.4.4-.6.9-.6 1.4h10.4c0-.5-.2-1.1-.6-1.5h-.1zM10.9 12c-.3 0-.5-.2-.5-.5s.2-.5.5-.5.5.2.5.5-.2.5-.5.5zm3.2 0c-.3 0-.5-.2-.5-.5s.2-.5.5-.5.5.2.5.5-.2.5-.5.5zM6 14v5.5c0 .8.7 1.5 1.5 1.5s1.5-.7 1.5-1.5V14H6zm13 0h-3v5.5c0 .8.7 1.5 1.5 1.5s1.5-.7 1.5-1.5V14zM5 13c-.8 0-1.5.7-1.5 1.5v4c0 .8.7 1.5 1.5 1.5s1.5-.7 1.5-1.5v-4c0-.8-.7-1.5-1.5-1.5zm14 0c-.8 0-1.5.7-1.5 1.5v4c0 .8.7 1.5 1.5 1.5s1.5-.7 1.5-1.5v-4c0-.8-.7-1.5-1.5-1.5zm-6 1h-3v6h3v-6z" />
    </svg>
);

export const GoogleIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} viewBox="0 0 24 24">
...
export const TelegramIcon: React.FC<IconProps> = ({ className = '', size = 'md' }) => (
    <svg className={`${sizeMap[size]} ${className}`} viewBox="0 0 24 24" fill="currentColor">
