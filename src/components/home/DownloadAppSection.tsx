...
import { useState } from 'react'; import { ArrowRightIcon } from '@/components/PremiumIcons';
                        ...
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            >
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                    {/* Android Button - MAINTENANCE MODE */}
                                    <button
                                        onClick={() => setMaintenanceModal({ isOpen: true, featureName: 'Download Android' })}
                                        className="btn-primary bg-gradient-to-r from-orange-500 to-amber-500 border-none shadow-lg px-8 py-4 text-lg group w-full sm:w-auto flex items-center justify-center relative"
                                    >
                                        <img src="/images/android-logo.png" alt="Android" className="w-6 h-6 mr-2 object-contain invert brightness-0" />
                                        Download Android
                                        <span className="ml-2 text-xs bg-white/20 px-2 py-0.5 rounded-full">MAINTENANCE</span>
                                    </button>
