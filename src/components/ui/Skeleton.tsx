...
export const CardSkeleton: React.FC<{ className?: string }> = ({ className = '' }) => (
    <div className={`bg-[var(--bg-primary)] rounded-2xl p-6 border border-[var(--border-light)] ${className}`}>
...
export const PricingCardSkeleton: React.FC = () => (
    <div className="bg-[var(--bg-primary)] rounded-3xl p-8 border border-[var(--border-light)]">
...
export const StatsSkeleton: React.FC = () => (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
            <div key={i} className="bg-[var(--bg-primary)]/80 rounded-xl p-4 text-center">
