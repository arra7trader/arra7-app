...
const PRICING_PLANS = [
    {
        ...
        features: [
            { text: '2x Analisa per hari', included: true, highlight: true },
            { text: 'Masa Aktif 2 Hari (Trial)', included: true, highlight: true },
            { text: 'Timeframe M5 dan M15', included: true, highlight: false },
            { text: 'Akses Gold & Major Pairs', included: true, highlight: false },
            { text: '🔥 Bookmap ARRA7 - Trial 2 hari', included: true, highlight: false },
        ],
        cta: 'Mulai Gratis',
        popular: false,
    },
