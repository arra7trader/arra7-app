                    ...
                    <div className="bg-[#1c1c1e] rounded-2xl p-8 border border-white/5">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[var(--accent-blue)]"
                                        placeholder="e.g. Master Trader John"
                                    />
                                </div>

                                <div>
                                    <label className="block text-sm text-gray-400 mb-1">Bio / Strategy Description</label>
                                    <textarea
                                        rows={4}
                                        value={formData.bio}
                            ...
                            <div className="space-y-4 pt-4">
                                <h3 className="text-lg font-semibold text-white border-b border-white/5 pb-2">Broker Connection</h3>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label className="block text-sm text-gray-400 mb-1">Account ID (Login)</label>
                                        <input
                                            type="text"
                                            required
                            ...
                            {/* Fees */}
                            <div className="space-y-4 pt-4">
                                <h3 className="text-lg font-semibold text-white border-b border-white/5 pb-2">Monetization</h3>

                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm text-gray-400 mb-1">Subscription Fee (IDR)</label>
                                        <input
                                            type="number"
                                            min="0"
                                            step="1000"
                                            ...
                                            className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[var(--accent-blue)]"
                                        />
                                        <p className="text-xs text-gray-500 mt-1">Monthly fee per follower (0 for free)</p>
                                    </div>
                                    <div>
                                        <label className="block text-sm text-gray-400 mb-1">Profit Sharing (%)</label>
                                        <input
                                            type="number"
                                            min="0"
                                            max="30"
                                            ...
                                            className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[var(--accent-blue)]"
                                        />
                                        <p className="text-xs text-gray-500 mt-1">Max 30% commission on profits</p>
                                    </div>
                                </div>
                            </div>
