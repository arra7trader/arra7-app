...
export default function MaintenancePage() {
    return (
        <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center px-6 py-20">
            <div className="w-full max-w-xl rounded-3xl border border-[var(--border-light)] bg-white p-8 shadow-sm">
                <div className="mb-6 inline-flex rounded-full bg-amber-100 px-3 py-1 text-xs font-semibold text-amber-700">
                    Maintenance Mode
                </div>
